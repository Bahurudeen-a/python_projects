"""
This is a project by A.Bahurudeen
"""
...
bird_rect = bird_img.get_rect(center = (67, 522 // 2))
bird_movement = 0 
gravity = 0.17
...
#displaying game over with image
game_over = False
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN: #key pressed Event
            if event.key == pygame.K_SPACE and not game_over: #if ket is pressed
                bird_movement = 0
                bird_movement  = -7
